...
def build_model(frame_size, action_dim, agent_history_length):
    inputs = Input(shape=(frame_size, frame_size, agent_history_length))
    conv0_0 = Conv2D(32, (8, 8), strides=2, activation='relu')(inputs)
    conv0_1 = Conv2D(32, (3, 3), padding='same' ,activation='relu')(conv0_0)
    conv0_2 = Conv2D(32, (3, 3), padding='same', activation='relu')(conv0_1)
    concat0 = concatenate([conv0_0, conv0_2], axis=-1)
    conv1_0 = Conv2D(64, (3, 3), strides=2, activation='relu')(concat0)
    conv1_1 = Conv2D(64, (3, 3), padding='same', activation='relu')(conv1_0)
